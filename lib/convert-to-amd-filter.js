...
module.exports = class ConvertToAMD extends Filter {
  constructor(app, inputTree, options = {}) {
    ...
    this.loadingFilePath = app.options.amd.loadingFilePath || 'assets';
    ...
    this.indexHtmlCaches = {
      'index.html': {
        scriptsToLoad: [],
        loadingScript: path.join(this.rootURL, this.loadingFilePath, 'amd-loading.js'),
        afterLoadingScript: path.join(this.rootURL, this.loadingFilePath, 'after-amd-loading.js')
      },
      'tests/index.html': {
        scriptsToLoad: [],
        loadingScript: path.join(this.rootURL, this.loadingFilePath, 'amd-loading-tests.js'),
        afterLoadingScript: path.join(this.rootURL, this.loadingFilePath, 'after-amd-loading-tests.js')
      }
    };
  }
